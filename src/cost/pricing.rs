...
impl PricingTable {
    pub fn default() -> Self {
        ...
        prices.insert("gpt-4o-search-preview-2025-03-11".to_string(), (0.0025, 0.01));
        prices.insert("gpt-4o-mini-search-preview".to_string(), (0.00015, 0.0006));
        prices.insert("gpt-4o-mini-search-preview-2025-03-11".to_string(), (0.00015, 0.0006));
        ...
        prices.insert("gpt-realtime-mini-2025-10-06".to_string(), (0.00015, 0.0006));
        prices.insert("gpt-realtime-mini-2025-12-15".to_string(), (0.00015, 0.0006));
        prices.insert("gpt-4o-realtime-preview".to_string(), (0.005, 0.02));
        prices.insert("gpt-4o-realtime-preview-2024-12-17".to_string(), (0.005, 0.02));
        prices.insert("gpt-4o-realtime-preview-2025-06-03".to_string(), (0.005, 0.02));
        prices.insert("gpt-4o-mini-realtime-preview".to_string(), (0.00015, 0.0006));
        prices.insert("gpt-4o-mini-realtime-preview-2024-12-17".to_string(), (0.00015, 0.0006));
        ...
        prices.insert("gpt-4o-mini-audio-preview-2024-12-17".to_string(), (0.00015, 0.0006));
        ...
        prices.insert("gpt-4o-mini-transcribe-2025-12-15".to_string(), (0.006, 0.006));
        prices.insert("gpt-4o-mini-transcribe-2025-03-20".to_string(), (0.006, 0.006));
